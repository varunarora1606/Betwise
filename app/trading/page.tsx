...
//   {
//     id: "1",
//     title: "Will India win the match against Pakistan?",
//     currentPrice: 65.5,
//     volume: "₹125K",
//     trend: "hot",
//   },
...
//   {
//     id: "3",
//     title: "Will ChatGPT 5 be released in 2024?",
//     currentPrice: 32.8,
//     volume: "₹56K",
//     trend: "new",
//   },
        ...
        {!selectedQuestion ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {questions.map((question, idx) => {
              question.trend = idx % 3 == 0 ? "trending" : idx % 3 == 1 ? "new" : "hot";
              return (
                <MarketCard
                  key={question.symbol}
                  question={question}
          ...
          <div className="flex gap-6 w-full flex-col md:flex-row">
            ...
            />
            <TradingForm selectedQuestion={selectedQuestion} transactionType={transactionType} setTransactionType={setTransactionType} />
          </div>
        )}
      </div>
    </div>
